    ...
    def dashboard():
        ...
        <body>
            <div class="header">
                <h1>🚌 SÍG Transporte</h1>
                <div>
                    <span>👤 {{ session.get('user_nombre', session.get('user_ci')) }} ({{ session.get('user_rol', 'usuario') }})</span>
            ...
            <div class="container">
                ...
                <div class="card">
                    ...
                    <div class="menu">
                        ...
                        <a href="/conductores">👨‍✈️ Gestionar Conductores</a>
                        <a href="/vehiculos">🚗 Gestionar Vehículos</a>
                        <a href="/rutas">🗺️ Gestionar Rutas</a>
                    </div>
                </div>
            </div>
        </body>
    ...
    def usuarios():
        ...
        <head>
            ...
            <style>
                ...
                .btn { padding: 6px 12px; background: #1a73e8; color: white; text-decoration: none; border-radius: 3px; border: none; cursor: pointer; }
                .btn:hover { background: #1557b0; }
        ...
        for u in usuarios:
            html += f'''
                        <tr>
                            ...
                            <td>
                                <a href="/usuario/{u.id}" class="btn">Ver</a>
                                <a href="/usuario/{u.id}/editar" class="btn">Editar</a>
                            </td>
                        </tr>
            '''
